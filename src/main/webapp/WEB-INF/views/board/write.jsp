    ...
    <script src="https://www.google.com/recaptcha/api.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-5 text-right">
                    <button type="button" class="btn btn-light" id="listbdbtn"><i class="fas fa-list"> 목록으로</i></button>
                </div>
            </div>
            ...
            <div class="card card-body bg-light col-10 offset-1">
                <form name="boardfrm" id="boardfrm">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" name="userid" id="userid" class="form-control col-9 border-danger" value="${UID}" readonly>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 text-center">
                            <button type="button" class="btn btn-primary" id="savebdbtn"><i class="fas fa-check-circle"></i> 입력완료</button>

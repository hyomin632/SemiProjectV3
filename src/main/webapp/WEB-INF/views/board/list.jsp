...
<div class="row">
	<div class="col-5 offset-1">
		<div class="form-group row">
			...
			<input type="text" name="findkey" id="findkey" class="form-control col-4 border-primary" value="${param.findkey}">&nbsp;
...
<div class="row">
	<div class="col-12">
		<ul class="pagination justify-content-center">
			...
			<li class="page-item <c:if test="${sp gt 11}"> disabled </c:if>">
				<a href="${pglink}${sp - 10}" class="page-link">이전</a>
			</li>

			<%-- 반복문을 이용해서 페이지 링크 생성 --%>
			<c:forEach var="i" begin="${sp}" end="${ep}" step="1">
				<%-- 표시하는 페이지 i가 총 페이지 수보다 작거나 같을 동안만 출력 --%>
				<c:if test="${i le tp}">
					<c:if test="${i eq cp}">

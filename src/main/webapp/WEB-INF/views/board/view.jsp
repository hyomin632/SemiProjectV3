...
<%--
    게시판 댓글 처리: reply
    댓글 번호 / 댓글 내용 / 작성자 / 작성일 / 부모글 번호 / 부모 댓글 번호
    1           방가방가   abc123   20210611    100
    2           옼케~      패티     20210611    100
    3           !!!!       잔망루피 20210611    100

    => 댓글 출력 순서는 부모글 번호로 추려낸 후, 부모 댓글 번호로 정렬
--%>
        ...
        <table class="table col-10 offset-1">
            <c:forEach var="r" items="${rps}">
                <c:if test="${r.rno eq r.rpno}">
                    ...
                    <span style="float:right"><c:if test="${not empty UID}"><a href="javascript:addReply('${r.rno}')">[추가]</a></c:if>
        ...
        <div class="row">
            <form name="replyfrm" id="replyfrm"
                ...
                <div class="form-group row justify-content-center">
                    ...
                    <button type="button" class="btn btn-dark form-control col-2 pushdwn" id="newbrbtn"><i class="fas fa-comment-dots"></i> 댓글 쓰기</button>
                </div>

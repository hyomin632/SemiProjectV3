...
<div class="row">
    <div class="col-5 offset-1">
        ...
        <div class="form-group row">
            ...
            <input type="text" name="jumin1" id="jumin1" class="border-primary form-control col-3"><span class="col-form-label">&nbsp;&mdash;&nbsp;</span>
...
<div class="row">
    <div class="col text-center">
        <hr>
        <button type="button" id="check2btn" class="btn btn-primary"><i class="fas fa-check"></i> 확인하기</button>

	        ...
	        <div>
	            <div class="col-11 offset-1">
	                <div class="form-group row">
	                    ...
	                    <input type="text" name="name" id="name" class="border-danger form-control col-2" readonly value="${param.name}">
	                </div> <!-- 이름 -->
	
	               <div class="form-group row">
	                   <label class="col-2 col-form-label text-danger text-right" for="jumin1">주민등록번호</label>
	                   <input type="text" name="jumin1" id="jumin1" class="border-danger form-control col-2" readonly value="${param.jumin1}">
	                   <span class="col-form-label">&nbsp;&mdash;&nbsp;</span>
	                   <input type="text" name="jumin2" id="jumin2" class="border-danger form-control col-2" readonly value="${param.jumin2}">
	               </div> <!-- 주민번호 -->
	               ...
	               <div class="form-group row">
	                   <label class="col-2 col-form-label text-danger text-right" for="chkpwd">비밀번호확인</label>
	                   <input type="password" name="chkpwd" id="chkpwd" class="border-danger form-control col-3">
	               ...
	               <div class="form-group row">
	                   ...
	                   &nbsp;
	                   <select class="form-control border-dnager col-2" id="email3">
	                       <option>-선택하세요-</option>
	                       <option>직접 입력</option>
	               ...
	               <div class="form-group row">
	                   <label class="col-4 col-form-label text-danger text-right" for="tel1">개인 연락처</label>
	                   <select class="form-control border-danger col-2" id="tel1" name="tel1">
	                       <option>-국번-</option>
	                       <option>010</option>
	                       <option>011</option>
	                       <option>016</option>
	               ...
	               <div class="form-group row">
	                   <label class="col-2 col-form-label text-danger text-right">자동 기입방지</label>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="zipfrm" id="zipfrm">
                    <div class="form-inline row justify-content-center">
                        <label class="col-form-label text-danger text-right" for="dong">검색하실 주소의<br> 동 이름을 입력하세요</label>
                        &nbsp;&nbsp;
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" id="sendzip"><i class="fas fa-check"></i> 선택하고 닫기</button>
            </div>
        </div>
    </div>
</div>
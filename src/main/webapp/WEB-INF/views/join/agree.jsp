	...
	<nav>
	    <ul class="breadcrumb">
	        <li class="breadcrumb-item active">
	            <button type="button" class="btn btn-success">이용약관</button>
	        </li>
...
Copyright © Kakao Corp. All rights reserved.
	        ...
	        <div class="custom-control custom-checkbox text-right">
	            ...
	            <label for="agree2" class="custom-control-label text-danger">개인정보 수집 및 이용에 동의합니다.
	            </label>
	        </div>
	    </form>
	</div> <!-- 이용약관/개인정보 수집 -->
